        ...
        <div class="modal-content">
            ...
            <form action="" id ="edit-student-form" >
                ...
                <div>
                    ...
                    <input type="text" id="edit-number" name="sNo" :value="activeStu.sNo" >
                </div>
                <div>
                    <label for="edit-birthYear">出生年</label>
                    <input type="text" id="edit-birthYear" name="birth" :value="activeStu.birth"
                    @input="edit('birth', $event.target.value)"
                    >
                </div>
                <div>
                    <label for="edit-phone">手机号</label>
                    <input type="text" id="edit-phone" name="phone" :value="activeStu.phone"
                    @input="edit('phone', $event.target.value)"
                    >
                </div>
                <div>
                    <label for="edit-address">住址</label>
                    <input type="text" id="edit-address" name='address' :value="activeStu.address"
...
export default {
  ...
  methods: {
    ...
    async commit() {
      ...
      try {
        const { msg } = await this.$api.updateStudent(user);
